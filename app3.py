    ...
    if loaded_rf_model and loaded_scaler and loaded_features:
        ...
        try:
            ...
            if listed_price < lower_bound:
                st.warning(listed_price + "This property appears to be **Underpriced**! Great deal!")
            elif listed_price > upper_bound:
                st.error(listed_price + "This property appears to be **Overpriced**! Consider negotiating.")
            else:
                st.success(listed_price + "This property appears to be **Fairly Priced**.")
