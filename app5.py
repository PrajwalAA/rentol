    ...
    if loaded_rf_model and loaded_scaler and loaded_features:
        ...
        try:
            ...
            if listed_price < lower_bound:
                st.warning(f"**₹{listed_price}**  This property appears to be **Underpriced**! Great deal!")
            elif listed_price > upper_bound:
                st.error(f"**₹{listed_price}**  This property appears to be **Overpriced**! Consider negotiating.")
            else:
                st.success(f"**₹{listed_price}**  This property appears to be **Fairly Priced**.")
